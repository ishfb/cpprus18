...
* Тестирование решений участников
  * Говорим, что большинство задач — это либо «stdin → stdout», либо функция/класс/шаблон с заданным интерфейсом
  * Показываем схему тестирования задач «stdin → stdout»
  * Теперь переходим к тестированию интерфейсов
