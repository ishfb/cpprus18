...
* Но надо накинуть технического мясца
  * Кратко описать наш юнит-тест фреймворк
    ...
    * Написали свой юнит-тест фреймворк, чтобы люди не воспринимали его как магию, а понимали, как он устроен внутри; кроме того, для его использования достаточно только тех знаний, которые были у нихна тот момент
...
* Рассказать о специализации и уже запущенных курсах
  ...
  * вопрос: кто слышал о белом или жёлтом поясе по С++?
...
* История о том, как мы начали, а потом всё выбросили
  ...
  * История, как я случайно посмотрел доклад Kate Gregory и понял, что мы все делаем не так
    * Вопрос в зал: кто видел этот доклад
...
* Первый принцип - понятность вместо полноты изложения
  ...
  * примеры из наших курсов
    ...
    * vector, map, set и т.д. как чёрные ящики
  * пример из жизни - интеграция нового сотрудника
    * вопрос в зал: кто проходил через полный рассказ?
* Демонстрация проблемы
  ...
  * Пример 4 — code review
    ...
    * Вопрос в зал: кто с таким сталкивался?
...
* Отзыв семиклассницы: «мы не зря выкинули три месяца»