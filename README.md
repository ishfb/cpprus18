...
* Демонстрация проблемы
  ...
  * Пример 4 — code review, берём кусок плохого кода и показываем комментарий типа: «Замени А на Б». Это плохой пример. Хороший пример: «Если мы оставим так, то вот в таком случае возникнет вот такая проблема, смотри: ... Поэтому здесь лучше подойдёт вот такой вариант»
* Практичность
