...
* Однако начну я немного с другого. На CppCon'2017 Страуструп выступил с докладом "Learning and Teaching Modern C++", в котором заявил, что мы все являемся учителями. За 1,5 года работы над специализацией по C++ у нас выработался набор принципов, которые, я уверен, применимы и повседневной работе:
  * в процессе интеграции нового сотрудника в проект
  * code-review
  * при найме
Поэтому я не просто хочу рассказать, как мы делаем эту специализацию, но и попытаюсь переложить полученный опыт на повседневные задачи.
